...
set cino+=:0                                           "add cino+=:0 for switch case by shengkun
"set foldenable                                        "启用折叠
set nofoldenable                                        "关闭折叠打开文件时不折叠
set foldmethod=indent                                 "indent 折叠方式
"set foldmethod=syntax									"syntax 折叠方式
" also, foldmethod=syntax, expr, diff, manual, indent, marker
"set foldmethod=marker
au BufRead * normal zR

" 用<F5>来开关折叠
nnoremap <F5> @=((foldclosed(line('.')) < 0) ? 'zc' : 'zo')<CR>
...
" 常规模式下输入 <F2> 调用插件，如果有打开 TagList 窗口则先将其关闭
nmap <F2> :TlistClose<CR>:TagbarToggle<CR>
...
" 常规模式下输入 <F6> 调用插件，如果有打开 Tagbar 窗口则先将其关闭
nmap <F6> :TagbarClose<CR>:Tlist<CR>
